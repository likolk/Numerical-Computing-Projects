...
# get the pagerank for www.usi.ch
(U, G) = surfer("https://www.swissinfo.ch/", 10, true)


# to generate a connectivity matrix for www.usi.ch, we use spy 
spy(G);
plot!(title="Connectivity Matrix", xlabel="https://www.swissinfo.ch/")
...
# surfer gives us U, G.
# we take the U, G given by the surfer, rename them to X, Y, and compute
# the pagerank of X, Y
# we then plot the pagerank of X, Y
